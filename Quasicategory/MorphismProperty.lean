...
def WeaklySaturatedClassOf (T : MorphismProperty C) : MorphismProperty C := fun _ _ f ↦ WeaklySaturatedOf T f

-- do galois connection, galois insertion

instance of_is (T : MorphismProperty C) : WeaklySaturated (WeaklySaturatedClassOf T) where
